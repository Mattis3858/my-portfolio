let resumeData = {
  ...
  aboutme:
    ...
    `朱茂榛，大學以及研究所皆在政治大學資訊管理學系就讀，目前碩一。擁有強大problem solving的能力，不畏懼問題，也願意與團隊一起溝通、合作。
        ...
        實習經驗：
        　　在學期間由於自學許多前端框架，因此通過同學介紹有幸進到未來巢科技股份有限公司實習。主要實習工作內容為使用React.js撰寫公司產品的網頁前端、串接後台API數據顯示於畫面上。由於公司為新創公司，所以身為實習生的我也會一起參與公司內部會議，與UI/UX團隊溝通開發的內容以及開發限制，同時非常考驗個人能力和與其他部門的溝通協調能力，需自行找資料或文件和研究更好的架構以及優化程式碼，但也能夠有效提升進步的速度。能在新創公司從頭開發第一線的產品的經驗是非常難能可貴的。未來希望能將這些經驗活用於更多的專案、研究以及工作上，也感謝未來巢科技公司讓我有這個難得的實習機會。\n
        專案經驗：
        　　在學期間在許多專案中負責製作網頁，也對網頁開發產生濃厚興趣，因此除了學校的課業外，在課餘時間自行學習React.js、Vue.js等前端框架，另外也學習Flask以及NextJS等網頁後端及全端的框架，在大三期間的產銷資訊系統課程中，我們小組的專題主題為幫助果乾小農管理銷貨、庫存管理資訊系統，而我在其中同樣負責前後端的開發以及串接。未來希望能結合前面所述之資訊以及金融科技能力應用於職涯中。除了網頁開發以外，其他專案也負責過使用者需求分析、資料庫管理、企劃書撰寫等工作項目。
        　　大四上結束了經歷一年半的畢業專案開發。畢業專案主題為幫助大學生擁有全新的品茶體驗，在團隊中主要負責前後端開發、資料庫建立、前後端串接、專案進度管理，透過實務上的經驗讓能更快的開發畢業專案並與團隊進行溝通合作。同時，我也善於規劃工作流程與專案開發時間，幫助團隊在時程內完成任務，與團隊成員一同完成畢業專案。
        　　碩一上
  ...
  portfolio: [
    ...
    },
    {
      name: "Knowledge Wave",
      description:
        "Next.js / TailwindCSS / GCP / Web Crawling / LLM / Langchain",
