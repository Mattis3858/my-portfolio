let resumeData = {
  ...
  aboutme:
    ...
    `我叫朱茂榛 Mattis，	目前碩一，大學以及研究所皆就讀國立政治大學資訊管理學系。擁有強大problem solving的能力，不畏懼困難或新的挑戰，願意與團隊一起溝通、合作。同時也是政大羽球校隊的一員，熱愛運動，不怕辛苦和磨練。

      課業學習：
      　　目前的碩士論文題目為 "Dynamic Tripartite Graph Neural Networks for Real-Time Recommendations in Live-Streaming E-Commerce"，本研究期望提出一種基於用戶、主播與產品三方異構圖的即時推薦模型，直接捕捉三者間複雜關係。模型利用圖神經網絡結合 PlatoGL 框架，實現連續更新與即時推薦，提升用戶參與度與轉換率。
      　　碩一上擔任資管系大學部的程式設計課程助教，透過設計、教學助教課，幫助大一新生了解 Java 運作原理、OOP 基本概念。
      　　在政大資管系不僅習得程式能力，同時也吸收商學以及資訊管理的相關知識。透過各課程，將所學知識運用在專案的開發，讓專業知識不只是紙上談兵。大四期間修習網路安全的資料科學課程，從中學習了非常多機器學習、語言模型、資料處理與分析的知識，並且在大學期間完成金融科技學程。在碩士班也將修習更多人工智慧以及大型語言模型更進階深入的課程，同時增進自己的硬實力與軟實力。

      實習經驗：
      　　主要實習工作內容為使用 React.js 開發及維護響應式網頁 ERP 應用程式、串接後台 API 數據動態渲染數據並提升使用者體驗。參與公司內部會議，與 UI/UX team 以及 PM 團隊共同開會，確保溝通順暢並按時交付專案成果。有效增進個人能力和與其他部門的溝通協調能力，並自行找資料或官方文件和研究更好的架構以及優化程式碼，有效提升自我進步，比起去大公司實習是做產品的維護及優化，我認為在新創公 司從無到有開發第一線的產品的經驗更難能可貴。希望未來能將這些經驗活用於更多的專案、研究以及工作，也感謝未來巢科技公司讓我有這個難得的實習機會。

      專案經驗：
      　　目前與政大財管系一起合作，在「環境揭露品質、永續金融及企業永續投資」國科會研究計畫中擔任研究助理。在研究中主要負責開發一套自動化系統，用於評估 TCFD 揭露報告，從而大幅降低 70% 的人力審查工作量並協助提升報告書評估效率。使用 Tensorflow 和 Hugging Face 對 ChineseBERT 進行微調，以解決文件級別過擬合和數據稀疏的問題。此外，還設計了一個基於文本平均嵌入向量的神經網絡，用於文件級別的多標籤分類，初步達到了約 71.18% 的準確率，再整合 RAG 與基於 LLM 的嵌入和 Chroma 向量資料庫，最終將分類準確率提升至 78.57%。
      　　大四上結束了經歷一年半的畢業專案開發，在「2023 Innoserve 資訊應用服務創新競賽資訊應用組獲得佳作」以及「2023 政大資管系專案發表第三名」。專案名稱為「TeaJourney」，目標是為大學生提供全新的品茶體驗，與在地茶行以及政大CSR團隊合作交流。我在團隊中主要負責需求分析、前後端開發、資料庫建立、前後端串接、專案進度管理，透過過去實務上的經驗讓能更快的開發畢業專案並與團隊進行溝通合作。同時，我也善於規劃工作流程與專案開發時間，幫助團隊在時程內完成任務，與團隊成員一同完成畢業專案。
      　　碩一上與組員一同開發 Knowledge Wave，透過自動化爬蟲每天抓取多個技術資訊來源（如 GitHub、Medium、CSDN）的最新文章，並利用 GCP 服務處理與儲存資料。平台採用 ETL 流程，先擷取文章標題、內容、網址、發布日期、標籤與按讚數，再進行文字清洗、翻譯（統一轉換成英文標籤）及向量化處理，存入 GCS 與 BigQuery（含向量資料庫）中。為各工程師使用者減少了每日搜索新技術以及追蹤新文章的時間成本。其中我主要負責前端網頁的開發、前後端串接以及後端文章爬蟲模組的開發。
      　　在學期間在許多專案中負責製作網頁，對網頁開發產生濃厚興趣，因此除了學校的課業外，在課餘時間自行學習 React.js、Vue.js 等前端框架，另外也學習 Flask 以及 NextJS 等網頁後端及全端的框架，在大三期間的產銷資訊系統課程中，我們小組的專題主題為幫助果乾小農管理銷貨、庫存管理資訊系統，我在其中負責前後端的開發以及串接。未來希望能結合前面所述之資訊以及金融科技能力應用於職涯中。除了網頁開發以外，其他專案也負責過使用者需求分析、資料庫存取與管理、企劃書撰寫等工作項目。`,
  address: "台北市文山區",
  ...
  achievements: [
    {
      Achievements:
        "國科會計畫「環境揭露品質、永續金融及企業永續投資」研究計畫研究助理",
    },
    {
  ...
  skills: [
    ...
    {
      skillid: 3,
      skillname: "LLMs / RAG / LangChain / Fine-tune",
    },
    {
      skillid: 4,
