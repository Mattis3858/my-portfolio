let resumeData = {
  ...
  aboutme:
    ...
    `我叫朱茂榛 Mattis，	目前碩一，大學以及研究所皆就讀國立政治大學資訊管理學系。擁有強大problem solving的能力，不畏懼困難或新的挑戰，願意與團隊一起溝通、合作。同時也是政大羽球校隊的一員，熱愛運動，不怕辛苦和磨練。
      ...
      【實習經驗】
        主要實習工作內容為使用 React.js 開發及維護網頁 ERP 應用程式、串接後台 API 數據動態渲染數據。參與公司內部跨部門會議，與 UI/UX Team 以及 PM 團隊共同開會，確保溝通順暢並按時交付專案成果。有效增進個人能力和與其他部門的溝通協調能力，並自行找資料或官方文件和研究更好的架構以及優化程式碼，有效提升自我進步，比起去大公司實習是做產品的維護及優化，我認為在新創公司從無到有開發第一線的產品的經驗更難能可貴。希望未來能將這些經驗活用於更多的專案、研究以及工作，也感謝未來巢科技公司讓我有這個難得的實習機會。
      ...
      【專案經驗】
        ...
        在學期間在許多專案中負責製作網頁，對網頁開發產生濃厚興趣，因此除了學校的課業外，在課餘時間自行學習 React.js、Vue.js 等前端框架，另外也學習 Flask 以及 Next.js 等網頁後端及全端的框架，在大三期間的產銷資訊系統課程中，我們小組的專題主題為幫助果乾小農管理銷貨、庫存管理資訊系統，我在其中負責前後端的開發以及串接。未來希望能結合前面所述之資訊以及金融科技能力應用於職涯中。除了網頁開發以外，其他專案也負責過使用者需求分析、資料庫存取與管理、企劃書撰寫等工作項目。`,
  address: "台北市文山區",
