let resumeData = {
  ...
  aboutme:
    ...
    `我叫朱茂榛 Mattis，	目前碩一，大學以及研究所皆就讀國立政治大學資訊管理學系。擁有強大 problem solving 的能力，不畏懼困難或新的挑戰，願意與團隊一起溝通、合作。同時也是政大羽球校隊的一員，熱愛運動，不怕辛苦和磨練。`,
  educationDescription: `目前的碩士論文題目為 "Dynamic Tripartite Graph Neural Networks for Real-Time Recommendations in Live-Streaming E-Commerce"，本研究期望提出一種基於用戶、主播與產品三方異構圖的即時推薦模型，直接捕捉三者間複雜關係。模型利用圖神經網絡結合 PlatoGL 框架，實現連續更新與即時推薦，提升用戶參與度與轉換率。`,
  internshipExperienceDescription: `主要實習工作內容為使用 React.js 開發及維護網頁 ERP 應用程式、串接後台 API 數據動態渲染數據。參與公司內部跨部門會議，與 UI/UX Team 以及 PM 團隊共同開會，確保溝通順暢並按時交付專案成果。有效增進個人能力和與其他部門的溝通協調能力，並自行找資料或官方文件和研究更好的架構以及優化程式碼，有效提升自我進步，比起去大公司實習是做產品的維護及優化，我認為在新創公司從無到有開發第一線的產品的經驗更難能可貴。希望未來能將這些經驗活用於更多的專案、研究以及工作，也感謝未來巢科技公司讓我有這個難得的實習機會。`,
  projectExperienceDescription: `目前與政大財管系一起合作，在「環境揭露品質、永續金融及企業永續投資」國科會研究計畫中擔任研究助理。在研究中主要負責開發一套自動化系統，用於評估 TCFD 揭露報告，從而大幅降低 70% 的人力審查工作量並協助提升報告書評估效率。使用 Tensorflow 和 Hugging Face 對 ChineseBERT 進行微調，以解決文件級別過擬合和數據稀疏的問題。此外，還設計了一個基於文本平均嵌入向量的神經網絡，用於文件級別的多標籤分類，初步達到了約 71.18% 的準確率，再整合 RAG 與基於 LLM 的嵌入和 Chroma 向量資料庫，最終將分類準確率提升至 78.57%。
